...
public class OrderServiceImplIntegrationTest {
    ...
    public void testFindOrderByCustomerId() {
        ...
        Customer c = new Customer(1, "Carol", "Shaw", "cshaw@mlb.com", "206-804-8771", "8157 Longview Court", "Seattle",
                "WA", "98121", null);
        customerRepository.save(c);

        Employee e = new Employee(1, "Jack", "Powell", "jpowell0@hplussport.com", "5 Jenifer Crossing", "Lynchburg",
                "VA", "24515", null);
